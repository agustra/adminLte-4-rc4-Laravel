    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ request()->is('admin/filemanager*') ? route('admin.lfm.unisharp.lfm.upload') : route('user.lfm.unisharp.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
